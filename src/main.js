...
createApp({
  setup() {
    ...
    // Default values 2024
    const priceStandardInput = ref(0.227);
    const priceRetrievalInput = ref(0.07139);
    const priceForCapacityInput = ref(5.2514);
    const percentageFromStoredInput = ref(33);
    const monthsInYearInput = ref(12);
    const priceSurplusInput = ref(0.086); // 2023m atpirkimo tarifas
    const surplusMaxInput = ref(500);
